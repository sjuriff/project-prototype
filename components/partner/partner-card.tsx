...
export default function PartnerCard ({ icon: Icon, title, description, cardRef }: PartnerCardProps)  {
    return (
      ...
      >
        ...
        <h3 className="mb-2 text-xl font-heading text-tertiary-text leading-none tracking-tight">
          {title}
        </h3>
        <p className="leading-relaxed font-body text-secondary">{description}</p>
      </div>
    );
  }
