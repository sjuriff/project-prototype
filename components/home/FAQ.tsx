...
export default function Faq() {
  ...
  return (
    <div ref={containerRef} className=" z-10 relative min-h-[50vh]  w-full py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex lg:gap-8 2xl:gap-16 h-full">
        <div id="card-left" className="w-1/2 flex xl:h-85 2xl:h-90  items-center justify-center   text-secondary-text">
        ...
        <div id="card-right" className="w-1/2  xl:h-85 2xl:h-90 flex  items-center justify-center ">
