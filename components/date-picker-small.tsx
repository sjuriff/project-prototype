...
export default function DatePicker({ value, onChange, className, setDays }: Props) {
  ...
  const update = (next: { from?: Date; to?: Date }) => {
    const days = next.from && next.to ? diffDays(next.from, next.to) : 0;
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 0 }}>
            <button
              ...
              className="font-body"
              style={{ border: "none", background: "transparent", cursor: "pointer", fontSize: 12, padding: "4px 10px" }}
            >
              ‹
            </button>
