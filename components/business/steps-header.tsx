    ...
    <div ref={containerRef} className="flex  items-center justify-center bg-background px-6">
      <div className="flex flex-col max-w-3xl items-center gap-4">
        <div className="relative ">
          ...
          <h1 ref={headingRef} className="text-5xl z-10 relative text-center  [text-shadow:2px_2px_6px_rgba(0,0,0,0.25)]  font-heading tracking-tight text-secondary-text">
